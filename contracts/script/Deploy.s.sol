...
contract Deploy is Script {
    function run() external {
        ...
        console.log("Using the factory to create the first market (SOL Price 2025)...");
        ...
        string memory description = "Solana (SOL) Price at end of 2025";
        
        // Pyth SOL/USD price id and expiry (Dec 31, 2025 00:00:00 UTC)
        ...
        string memory lpTokenName = "Normals SOL 2025 LP Token";
        string memory lpTokenSymbol = "NORM-SOL-LP";

        // Collateral token (address(0) for native SOL; set to SOL address for SOL markets)
        ...
        console.log("First market (SOL Price 2025) deployed at address:", firstMarketAddress);
